...
;// CONCATENATED MODULE: ./src/ui_components/header/credits/self_credits.js
...
/* harmony default export */ const self_credits = (createSelfCredits);

;// CONCATENATED MODULE: ./src/ui_components/header/header.js


function createHeader() {
  let header = document.createElement("header");
  let h1 = document.createElement("h1");
  let credits = self_credits();
...
/* harmony default export */ const header_header = (createHeader);

;// CONCATENATED MODULE: ./src/ui_components/main_section/current_weather_display/current_weather_display.js
...
/* harmony default export */ const current_weather_display = (createCurrWeatherCard);

;// CONCATENATED MODULE: ./src/ui_components/main_section/future_forecast_display/future_forecast_display.js
...
let dataProcessor = (function dataProcessor() {
  ...
  const processWeatherFeedback = (futureWeather) => {
    ...
    let imageURL = icon_retriever.getIcon(currentConditions.condition.code);
...
;// CONCATENATED MODULE: ./src/ui_components/main_section/current_weather_display/today_more_weather_info_card/more_today_info.js
...
/* harmony default export */ const more_today_info = (createMoreTodayInfoCard);
...
;// CONCATENATED MODULE: ./src/ui_components/main_section/current_weather_display/update_current_weather_card.js
...
function updateCurrentWeatherCard() {
  ...
  let moreInfo = more_today_info(
    in_session_storage.getTodayData().extras.wind_kph,
    in_session_storage.getTodayData().extras.humidity
  );
...
/* harmony default export */ const update_current_weather_card = (updateCurrentWeatherCard);

;// CONCATENATED MODULE: ./src/ui_components/main_section/future_forecast_display/clear_future_weather_card.js
...
/* harmony default export */ const clear_future_weather_card = (clearFutureWeatherCard);

;// CONCATENATED MODULE: ./src/ui_components/main_section/future_forecast_display/update_future_weather_card.js
...
function updateFutureWeatherCard() {
  let futureWeatherCard = document.querySelector(".future.weather.card");
  let futureWeatherArray = in_session_storage.getForecastData();
...
/* harmony default export */ const update_future_weather_card = (updateFutureWeatherCard);

;// CONCATENATED MODULE: ./src/ui_components/ui_controller.js
...
let displayController = (function () {
  const displayWeatherDetails = () => {
    clear_current_weather_card();
    update_current_weather_card();

    console.log(in_session_storage.getTodayData());
  };

  const displayFutureWeather = () => {
    clear_future_weather_card();
    update_future_weather_card();

    console.log(in_session_storage.getForecastData());
  };
...
function listenForUserInput(searchButton, locationInput, form) {
  const completeWeatherSearchProcedure = async () => {
    ...
    loading_control.startLoading();

    try {
      let futureWeather =
        await weather.fetchFutureWeatherByLocation(location);
      let { processedTodayWeather, processedFutureWeather } =
        data_processor.processWeatherFeedback(futureWeather);

      loading_control.stopLoading();
  ...
  const completeLocationSearchProcedure = async () => {
    ...
    let locations = await weather.getCitiesStartingWith(location);
    let processedData = data_processor.processLocationArray(locations);
    ui_controller.displayLocations(processedData);
  };
...
/* harmony default export */ const main_section = (createMainSection);

;// CONCATENATED MODULE: ./src/ui_components/init_ui.js
...
/* harmony default export */ const init_ui = (createUI);
